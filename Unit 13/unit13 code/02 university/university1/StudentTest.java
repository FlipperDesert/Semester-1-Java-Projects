 ...
 * Note: This is NOT a full test of the class
 * 
 * @author (your name) 
...
public class StudentTest
{
    ...
    public void doTest()
    {
        Student stud1 = new Student(1234, "Mary");   // declare
        Student stud2 = new Student(2345, "Anne");   // Alternative: declare & create 
        Student stud3 = new Student(3456, "Jo");     // Alternative: declare & create
