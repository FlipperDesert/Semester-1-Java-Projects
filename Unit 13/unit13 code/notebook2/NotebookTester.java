...
public class NotebookTester
{
    public static void main (String args[]){
        ...
        notes.storeNote(0, new Note("Week 1","These are my coursenotes for week 1"));
        notes.storeNote(1, new Note("Instructions", "To get into London......"));
        notes.storeNote(2, new Note ("List of Courses", "The list of courses is: Sleeping for beginners, Advanced partying, Late Night Drinking for Dummies"));
        
        //another way of adding a note
        Note memo = new Note("Reminder", "Do Java exercises today");
        notes.storeNote(3, memo);
