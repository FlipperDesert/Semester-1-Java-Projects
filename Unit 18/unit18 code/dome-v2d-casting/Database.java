...
public class Database
{
    ...
    /** get all CD no of tracks - ONLY way to do this
     */
    ...
    /** get Directors/Artists- NOT recommended
     */
    ...
    {   
        for(Item temp: items) {
            ...
            {   // need to use casting: cast the object, call its method 
                System.out.println(((DVD)temp).getDirector());
            }
            if (temp instanceof CD)
            {   // need to use casting: cast the object, call its method  
                System.out.println(((CD)temp).getArtist());
            }
        }
